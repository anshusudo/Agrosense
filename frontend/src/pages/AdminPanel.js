...
function AdminPanel() {
  ...
  return (
    <div className="admin-page" style={{ maxWidth: 1100, margin: '0 auto', padding: 20 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <h3>Users</h3>
        <div className="admin-table-wrap" style={{ overflowX: 'auto', border: '1px solid #e2e8f0', borderRadius: 10 }}>
